    ...
    return (
        <Container maxWidth='xl'>
            ...
            <Typography variant='body1' gutterBottom className='animate-center'>
                Если тебе не хватает разговорной практики английского языка и ты
                хотел(а) бы использовать свои знания языка и навыки в общении с
                единомышленниками на разные темы, то мой разговорный клуб - это
                отличная возможность не только “пустить в ход” и отточить
                имеющиеся знания и приемы в английском, но и узнать много новой
                лексики и грамматики на самые разные разговорные темы в уютной
                атмосфере нашего клуба!
            </Typography>
            <Typography variant='body1' gutterBottom className='animate-center'>
                А еще наш разговорный клуб проходит с носителем английского
                языка, поэтому не пропустите отличную возможность напрямую
                пообщаться с представителем Англии!
            </Typography>
