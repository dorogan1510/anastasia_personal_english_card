    ...
    return (
        <Container id='id7' maxWidth='xl'>
            ...
            <Typography variant='body1' gutterBottom className='animate-center'>
                ...
                <b>
                    грамматика, лексика, произношение или другие аспекты и
                    навыки в использовании английского/немецкого языка.
                </b>{' '}
                Я внимательно изучу нашу проблему и приготовлю презентацию с
            ...
            >
                ...
                <b>
                    {' '}
                    Вы — начинающий преподаватель или делаете свои первые шаги в
                    преподавании ОНЛАЙН
                </b>{' '}
                и хотите узнать о полезных сайтах и ресурсах, усовершенствовать
                свои навыки работы в онлайн или же научиться выстраивать урок
                эффективно и интересно для ученика, то я предлагаю Вам
                записаться на консультацию для преподавателей. В комплект
                консультации входят: запись звонка на 1.5 часа+презентация с
