        ...
        >
            <Box className='animate-left'>
                ...
                <Typography variant='body1' gutterBottom>
                    ...
                    созваниваемся и обсуждаем ваш опыт изучения
                    языка,цели,предпочтения и ожидания от обучения. Программа,
                    которую подбираю для учеников по ходу курса в дальнейшем
            ...
            <Box className='animate-left'>
                ...
                <Typography variant='body1' gutterBottom>
                    ...
                    разнообразие в свои уроки с помощью песен, коротких фильмов
                    и статей на английском языке. У каждого моего студента есть
