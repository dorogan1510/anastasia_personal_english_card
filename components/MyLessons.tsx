    ...
    return (
        ...
        >
            <Box className='animate-left'>
                ...
                <Typography variant='body1' gutterBottom>
                    Программа, которую я подбираю для учеников по ходу курса в
                    дальнейшем корректируется в соответствии с успехами и
                    пожеланиями ученика.
                </Typography>
                <Typography variant='body1' gutterBottom>
                    Мои уроки проходят на платформах Edvibe, Amazy, Miro и
                    Google Jjamboard. Каждый урок я создаю лично и стараюсь
                    сделать его максимально интерактивным, красочным и
